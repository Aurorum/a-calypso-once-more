...
export default connect( state => {
	...
	const isJetpackLogin = currentRoute === '/log-in/jetpack' || currentRoute === '/log-in/jetpack/link';
	const noMasterbarForRoute = currentRoute === '/log-in/jetpack' || currentRoute === '/log-in/jetpack/link';
